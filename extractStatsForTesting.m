...
%output files
muvx_file = '/home/vvasco/dev/egomotion/datasets/training data/muvx-ae-test';
muvy_file = '/home/vvasco/dev/egomotion/datasets/training data/muvy-ae-test';
sigmavx_file = '/home/vvasco/dev/egomotion/datasets/training data/sigmavx-ae-test';
sigmavy_file = '/home/vvasco/dev/egomotion/datasets/training data/sigmavy-ae-test';
sigmavxvy_file = '/home/vvasco/dev/egomotion/datasets/training data/sigmavxvy-ae-test';
...
time_file = '/home/vvasco/dev/egomotion/datasets/training data/timeencoders_xae.txt';

%load data
jointvelname = '/home/vvasco/dev/Data/iCub/egomotion/pure_egomotion/encoders/data.log';
[t, v0, v1, v2, v3, v4, v5] = joint_velocities(jointvelname);
encoders = [v0, v1, v2, v3, v4, v5];

flowfilename = '/home/vvasco/dev/egomotion/datasets/training data/flow/flow_xae.txt';
...
icut_start = find(t > flow(1, 6), 1);
icut_end = find(t > flow(end, 6), 1);
...
for k = 1 : length(v0)     
    ...
    %display percentage
    if( ( ( k / length(v0) ) * 100 ) > perc )
        display([int2str( ( k / length(v0)) * 100 ) '% done']);
        perc = perc + 10;
    end
end

dlmwrite(time_file, t, 'delimiter', ' ', 'precision', 20);